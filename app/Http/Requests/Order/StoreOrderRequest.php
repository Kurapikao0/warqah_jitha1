...
class StoreOrderRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'address_id.exists' =>
                'عنوان الشحن المحدد غير موجود أو لا ينتمي إلى حسابك.',
            ...
            'items.*.product_id.exists' =>
                'أحد المنتجات المحددة غير موجود.',
            ...
            'items.*.quantity.integer' =>
                'كمية المنتج يجب أن تكون رقماً صحيحاً.',

            'items.*.quantity.min' =>
                'يجب أن تكون كمية المنتج أكبر من صفر.',


            'items.*.customization_id.exists' =>
                'طلب التخصيص المحدد غير موجود.',
